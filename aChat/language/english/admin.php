...
define("_AM_ACHAT_EMPTY_FIELD", "Please fill in the field(s).");

// Permissions
define("_AM_ACHAT_PERM_CANPOST", "Allowed to post messages");

// Purge
define("_AM_ACHAT_PURGEPERNBRE", "Purge by number of messages");
define("_AM_ACHAT_PURGE_HOWMANY", "How many messages to purge?");
define("_AM_ACHAT_PURGE_CREATELOG", "Create a logfile with the purged messages?");
define("_AM_ACHAT_PURGE_VALIDATE", "Are you sure you want to purge&nbsp;");
define("_AM_ACHAT_PURGE_SUPPR_NOLOG", "without logfile");
define("_AM_ACHAT_PURGE_ERROR_WRITEFILE", "An error occured during logfile's creation. Please check that the folder in the module parameters is correct and that there the good rights are set on it.");
define("_AM_ACHAT_PURGE_LOG_WRITTEN", "Logfile created.");
define("_AM_ACHAT_PURGE_CANCELED", "Purge Cancelled.");
define("_AM_ACHAT_PURGE_OK", "Purge OK.");
define("_AM_ACHAT_PURGE_NBREMSGDEL", "Number of deleted messages: ");
define("_AM_ACHAT_PURGE_ERROR", "An error occured during the purge.");
...
define("_AM_ACHAT_DELETEMSG_MID", "mid of the message to delete<br />(last number displayed when you put the mouse on the poster's nickname,<br /> only displayed for admins)");
...
define("_AM_ACHAT_CLONENAME", "Clone name<br /><i>
                                         <ul>
                                             ...
                                             <li>Capitals and spaces allowed</li>
                                         </ul></i>
                                         Sample: 'My Module 01'. ");
